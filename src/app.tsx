        ...
        <div className='fixed insert-0 bg-black/60 flex items-center justify-center'>
          <div className='w-[640px] rounded-xl py-5 px-6 shadow-shape bg-zinc-900 space-y-5'>
            ...
            <div className='flex flex-wrap gap-2'>
              <div className='px-2.5 py-1.5 bg-zinc-800 rounded-md flex items-center gap-2'>
            ...
            <form className='p-3 bg-zinc-950 border-zinc-800 rounded-lg flex items-center'>
              <div className='px-2 flex items-center gap-2 flex-1'>
                <AtSign className='size-5 text-zinc-400'/>
                <input type="text" placeholder='Digite o e-mail do convidado' className='bg-transparent text-lg placeholder:text-zinc-400 outline-none flex-1'/>
              </div>
