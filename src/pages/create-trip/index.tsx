        ...
        <div className='fixed insert-0 bg-black/60 flex items-center justify-center'>
          <div className='w-[640px] rounded-xl py-5 px-6 shadow-shape bg-zinc-900 space-y-5'>
            ...
            <form onSubmit={addEmailToInvite} className='space-y-3'>
              ...
              <button type='submit' onClick={createTrip} className='bg-lime-300 text-lime-950 w-full justify-center h-11 rounded-lg font-medium flex items-center gap-2 hover:bg-lime-400'>
